...
exports.A2UIVisualizer = void 0;
class A2UIVisualizer {
    /**
     * Generate ASCII tree representation of component hierarchy
     */
    visualizeTree(surface) {
        if (!surface.rootId) {
    ...
    renderNode(node, components, prefix, isLast) {
...
exports.A2UIVisualizer = A2UIVisualizer;
